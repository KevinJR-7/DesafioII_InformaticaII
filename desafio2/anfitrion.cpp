...
Anfitrion::Anfitrion() : antiguedad(0), puntuacion(0)
{
    ...
    alojamientos = new unsigned short[50]();
}
...
const unsigned short* Anfitrion::getAlojamientos() const { return alojamientos; }
...
void Anfitrion::setAlojamientos(const unsigned short alojamientos[])    // necesario un alojamento 0 al final si son menos de 50
{
    unsigned short i = 0;
    for(i = 0; i < 50; i++)
    {
